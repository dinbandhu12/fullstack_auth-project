		...
		>
			<div className='p-8'>
				...
				<form onSubmit={handleLogin}>
					...
					<div className='flex items-center mb-6'>
						<Link to='/forgot-password' className='text-sm text-blue-400 hover:underline hover:font-bold'>
							Forgot password?
						</Link>
					</div>
			...
			<div className='px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center'>
				<p className='text-sm text-gray-400'>
					...
					<Link to='/signup' className='text-blue-400 hover:underline hover:font-bold'>
						Sign up
					</Link>
				</p>
			</div>
